...
client.on('message', msg => {
  if (msg.content === '&bot') {
    msg.reply(`**hello i created by LORD14GAMER
...
نأمل ان يعجبك البوت 
البوت حاليا تحت التطوير
ان كان لديك اقتراح لتطوير البوت المرجو كتابته في روم الاقتراحات بسيرفر البوت**`)
